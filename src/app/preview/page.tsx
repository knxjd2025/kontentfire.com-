...
/**
 * /preview — Editorial system applied to the KontentFire homepage.
 * All copy verbatim from the live site.
 *
 * Visual moves:
 *   • Canvas Cream (#F3F0EE) page background — never white
 *   • Extreme-radius vocabulary: 20px buttons, 40px hero stadium frames,
 *     999px nav pill, 50% circular portraits
 *   • Circular feature portraits with white satellite-CTA buttons
 *     attached to bottom-right + orbital orange arcs connecting them
 *   • Ghost cream-on-cream watermark headlines behind portrait cards
 *   • Sofia Sans (open-source MarkForMC stand-in) at weight 450 body
 *   • Ink-pill primary CTAs; signal orange reserved for dots & accents
 *   • Ink-black footer with conversational H2 + country pill
 */
...
const platforms = ["LinkedIn", "Facebook", "Instagram", "X/Twitter"] as const;
...
export default function PreviewHome() {
  return (
    <>
      {/* ============================================================
          NAV — floating pill, white surface, soft shadow
          ============================================================ */}
          ...
          <div className="hidden lg:flex items-center" style={{ gap: 26 }}>
            <div className="nav-item">
              ...
              <div className="nav-dropdown" role="menu">
                <Link href="/features" className="nav-dropdown-link" role="menuitem">
                  All Features
                </Link>
                <Link href="/how-it-works" className="nav-dropdown-link" role="menuitem">
                  How It Works
                </Link>
                <Link href="/free-trial" className="nav-dropdown-link" role="menuitem">
                  Free Trial
                </Link>
              </div>
            </div>
            ...
            <div className="nav-item">
              ...
              <div className="nav-dropdown" role="menu">
                <Link href="/guides" className="nav-dropdown-link" role="menuitem">
                  Platform Guides
                </Link>
                <Link href="/guides/books" className="nav-dropdown-link" role="menuitem">
                  Books
                </Link>
                <Link href="/blog" className="nav-dropdown-link" role="menuitem">
                  Blog
                </Link>
                <Link href="/resources" className="nav-dropdown-link" role="menuitem">
                  Resources
                </Link>
                <Link href="/tools" className="nav-dropdown-link" role="menuitem">
                  Free Tools
                </Link>
                <Link href="/faq" className="nav-dropdown-link" role="menuitem">
                  FAQ
                </Link>
      ...
      {/* ============================================================
          HERO — 64px headline + 40px stadium video frame
          ============================================================ */}
      <section className="px-4 md:px-6 lg:px-8 pt-12 md:pt-16 pb-10 md:pb-14">
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-end mb-10 lg:mb-14">
            <div className="lg:col-span-7 rise r-2">
              <span className="t-eyebrow">AI-Powered Content Automation</span>
              <h1 className="t-h1 mt-6">
                Set Your Social Media on Fire.
              </h1>
            </div>
            <div className="lg:col-span-5 rise r-3">
              <p className="t-body-lg" style={{ maxWidth: 520 }}>
                ...
                Twitter. Save hours every week whether you&apos;re a contractor,
                agency, creator, or small business.
              </p>
          ...
          {/* Stadium video frame */}
          <div className="stadium stadium-shadow rise r-4" style={{ aspectRatio: "16 / 9", maxHeight: 620 }}>
            <video
              autoPlay
              loop
              muted
            ...
            {/* Inline benefit chips overlaid on the stadium */}
            <div
              className="absolute bottom-7 left-7 right-7 flex flex-wrap items-center gap-2"
              style={{ zIndex: 2 }}
            >
              {heroBenefits.map((b) => (
                <span key={b} className="chip-inverse chip">
                  {b}
                </span>
              ))}
            </div>
      ...
      {/* ============================================================
          FEATURES — circular portraits with satellite CTAs +
          orbital arcs connecting them
          ============================================================ */}
      <section
        id="features"
      ...
      >
        <div className="max-w-[1240px] mx-auto relative">
          ...
          <span
            className="ghost-watermark hidden lg:block"
            style={{ top: 200, right: -60, textAlign: "right" }}
            aria-hidden
          >
            you need
          </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-16 lg:mb-24 relative" style={{ zIndex: 1 }}>
            ...
            <p className="lg:col-span-5 t-body-lg" style={{ alignSelf: "end" }}>
              From AI-powered content creation to automated publishing,
              KontentFire has all the tools you need to build a powerful social
              media presence.
            </p>
          </div>
          ...
          <div className="relative" style={{ zIndex: 2 }}>
            {/* Orbital arcs SVG layer */}
            <svg
              className="orbit-svg hidden lg:block"
            ...
            >
              <path
                ...
                d="M 200 180 C 380 90, 620 90, 800 180"
              />
              <path
                className="orbit-path"
                d="M 1000 200 C 1100 360, 950 480, 800 500"
              />
              <path
                className="orbit-path"
                d="M 600 540 C 460 660, 280 660, 180 540"
              />
              <path
                className="orbit-path"
                d="M 200 760 C 380 700, 620 700, 800 760"
              />
            </svg>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-20 lg:gap-y-28">
              {features.map((feature, i) => {
                ...
                return (
                  <article
                    key={feature.title}
                    className={`relative ${offsetClasses[i]}`}
                  >
                    {/* Circular portrait */}
                    <div
                    ...
                    {/* Eyebrow + title + description below */}
      ...
      {/* ============================================================
          FREE TRIAL BANNER — lifted cream surface in stadium frame
          ============================================================ */}
        ...
        <div className="max-w-[1240px] mx-auto">
          <div
            ...
            style={{
              padding: "64px 56px",
              background:
                "linear-gradient(135deg, #fcfbfa 0%, #f4e4cc 50%, #e8d3b4 100%)",
            }}
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <p className="t-body-lg mt-6" style={{ maxWidth: 560 }}>
                  Try every feature with no restrictions. Create AI-powered
                  content, schedule posts, and publish to all your social
                  accounts.
                </p>
                ...
                >
                  {trialBenefits.map((b, i) => (
                    <div
                      ...
                      style={{
                        padding: "16px 0",
                        borderBottom: "1px solid rgba(20,20,19,0.12)",
                      }}
                    >
                      <span
                        style={{
      ...
      {/* ============================================================
          SOCIAL PROOF — mockup posts in stadium frames, asymmetric
          ============================================================ */}
      <section className="px-4 md:px-6 lg:px-8 pb-20 md:pb-28">
        <div className="max-w-[1180px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-14 items-end">
            ...
            <p className="lg:col-span-5 t-body-lg">
              Real examples of AI-generated social media posts across every
              major platform.
            </p>
          </div>
            ...
            {socialPosts.map((post, i) => {
              ...
              return (
                <div key={post.platform} className={offsetClasses[i]}>
                  <article
                    className="stadium stadium-shadow"
      ...
      {/* ============================================================
          PRICING — three stadium-radius cards, no popular ring
          ============================================================ */}
      <section
        id="pricing"
      ...
      >
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-14 items-end">
            ...
            <p className="lg:col-span-5 t-body-lg">
              Simple, transparent pricing. Cancel anytime, no hidden costs. Sign
              up now and lock in 80% off your monthly plan.
            </p>
          </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-2 mt-1">
                      ...
                      <span className="t-caption" style={{ color: isFeatured ? "rgba(243,240,238,0.65)" : "var(--slate)" }}>
                        / month
                      </span>
                    </div>
                    <div
          ...
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              >
                <div style={{ fontSize: 16, fontWeight: 500, letterSpacing: "-0.02em" }}>{item.label}</div>
      ...
      {/* ============================================================
          EARLY ADOPTERS — clean numbered grid + inline CTA
          ============================================================ */}
      <section className="px-4 md:px-6 lg:px-8 pt-20 md:pt-28 pb-20 md:pb-28">
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-16 items-end">
            ...
            <p className="lg:col-span-5 t-body-lg">
              KontentFire is transforming how businesses create and manage
              social media content. Join our growing community of early
              adopters.
            </p>
          </div>
          ...
          <div className="mt-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5">
              <p className="t-body-lg">
                Join forward-thinking businesses and creators who are automating
                their content creation with AI. Start your special offer today.
              </p>
      ...
      {/* ============================================================
          DASHBOARD — real screenshot in 40px stadium frame
          ============================================================ */}
        ...
        <div className="max-w-[1240px] mx-auto">
          <div className="text-center mb-14 max-w-[820px] mx-auto">
            ...
            <p className="t-body-lg mt-6">
              Manage content, schedule posts, and track performance from one
              powerful dashboard.
            </p>
          </div>
      ...
      {/* ============================================================
          POPULAR LOCATIONS — pill-shaped city links
          ============================================================ */}
      <section className="px-4 md:px-6 lg:px-8 pt-20 md:pt-24 pb-20">
        <div className="max-w-[1240px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end mb-12">
            ...
            <p className="lg:col-span-5 t-body-lg">
              KontentFire helps businesses across the United States automate
              their social media content. Find local marketing insights for
              your area.
            </p>
          </div>
      ...
      {/* ============================================================
          FINAL CTA — large conversational headline + ink pill,
          on cream canvas with subtle warm gradient halo
          ============================================================ */}
      <section className="px-4 md:px-6 lg:px-8 pt-24 md:pt-32 pb-24 md:pb-32 relative overflow-hidden">
        ...
        <div className="relative max-w-[920px] mx-auto text-center">
          ...
          <p className="t-body-lg mt-8 mx-auto" style={{ maxWidth: 580, color: "var(--granite)" }}>
            ...
            growing their audience with KontentFire.
          </p>
      ...
      {/* ============================================================
          FOOTER — ink black, conversational H2, editorial signoff
          ============================================================ */}
      <footer className="footer">
        <div className="max-w-[1320px] mx-auto px-6 md:px-10 lg:px-14 pt-10 pb-6">
          {/* Conversational H2 + CTA */}
